...
<%
	...
	nameCookie.setMaxAge(60*10);	// expire 10 minutes later
	Cookie idCookie=new Cookie("uid",String.valueOf(userid));
	idCookie.setMaxAge(60*10);		// expire 10 minutes later
								...
								<td class="myMenu" align="right">
									...
									<table class="rootVoices" cellspacing='0' cellpadding='0'
										...
										<tr>
											...
											<td class="rootVoice {menu: 'empty'}"
												onclick="window.location='./workflowevaluation/hcwe.html'">HCWE</td>
											<td class="rootVoice {menu: 'empty'}"
				...
				<tr>
					...
					<%
					  ...
					  if(history.getServiceId()==1) {
						  ...
						  url = "<a href='workflowevaluation/hcwe_display.html?link=true&param=" + history.getParam() + "'>查看</a>";
